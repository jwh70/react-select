...
var Async = function (_Component) {
	...
	createClass(Async, [{
		...
		value: function render() {
			...
			}, defineProperty(_props5, 'options', isLoading && loadingPlaceholder && !isLoadingPage ? [] : options), defineProperty(_props5, 'ref', function ref(_ref) {
				return _this3.select = _ref;
			}), _props5);

			return children(_extends({}, this.props, props, (_babelHelpers$extends = {
				isLoading: isLoading,
				onInputChange: this.onInputChange,
				asyncLoadOptions: this.loadOptions
			}, defineProperty(_babelHelpers$extends, 'onInputChange', this._onInputChange), defineProperty(_babelHelpers$extends, 'onMenuScrollToBottom', this._onMenuScrollToBottom), _babelHelpers$extends)));
		}
	}]);
	return Async;
}(Component);
