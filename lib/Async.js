...
var Async = function (_Component) {
	...
	_createClass(Async, [{
		...
		value: function render() {
			...
			}, _defineProperty(_props5, 'options', isLoading && loadingPlaceholder && !isLoadingPage ? [] : options), _defineProperty(_props5, 'ref', function ref(_ref) {
				return _this3.select = _ref;
			}), _props5);

			return children(_extends({}, this.props, props, (_extends2 = {
				isLoading: isLoading,
				onInputChange: this.onInputChange,
				asyncLoadOptions: this.loadOptions
			}, _defineProperty(_extends2, 'onInputChange', this._onInputChange), _defineProperty(_extends2, 'onMenuScrollToBottom', this._onMenuScrollToBottom), _extends2)));
		}
	}]);
